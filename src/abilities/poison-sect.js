export const POISON_SECT_ABILITIES = {
  1: [
    ...
    { name: 'Toxic Shield', effect: 'shield_poison_chance', value: 30, amount: 4, emoji: '🛡️', description: 'Each time when a shield stack is gained, 30% chance to apply 4 stacks of poison to opponent' },
    ...
    { name: 'Venomous Strike', effect: 'attack_poison_chance', value: 60, amount: 3, emoji: '⚔️', description: '60% chance to apply 3 poison stacks on attack' },
    { name: 'Toxic Blood', effect: 'damage_poison_reflect', value: 20, amount: 2, emoji: '🩸', description: '20% chance to apply 2 poison stacks when taking damage' },
    ...
    { name: 'Corrosive Touch', effect: 'crit_poison_chance', value: 40, amount: 3, emoji: '💥', description: '40% chance to apply 3 poison stacks on critical hits' },
  ...
  2: [
    { name: 'Corrosive Toxin', effect: 'damage_poison_chance', value: 30, amount: 8, emoji: '🧪', description: '30% chance to apply 8 stacks of poison when taking damage' },
    ...
    { name: 'Toxic Tearing', effect: 'deal_damage_poison_chance', value: 30, amount: 8, emoji: '🗡️', description: '30% chance to apply 8 stacks of poison when dealing damage to opponent' }
  ],
  3: [
