export const SHIELD_SECT_ABILITIES = {
  1: [
    ...
    { name: 'Healing Shield', effect: 'heal_shield_chance', value: 25, amount: 4, emoji: '💚', description: '25% chance to gain 4 stacks of shield when HP is restored' },
  ...
  2: [
    ...
    { name: 'Shield Strike', effect: 'shield_damage_chance', value: 25, amount: 40, emoji: '⚔️', description: 'Each time when a shield is gained, 25% chance to strike opponent dealing 40 physical damage' },
